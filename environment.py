...
class PortfolioEnv:
    ...
    def __init__(self, start_date, end_date, download,action_scale=1, action_interpret='portfolio',
                 state_type='indicators', djia_year=2014):
        self.loader = Loader(djia_year=djia_year)
        self.download = download
        self.historical_data = self.loader.load(start_date, end_date,download)
